				...
				<table class="table table-striped table-advance table-hover">
				  ...
				  <tbody>
					<tr>
					  ...
					  <td>
						<a href="{{ $row->id }}" class="btn btn-success btn-xs"><i class="fa fa-check"></i></a>
						<a href="users/edit/{{ $row->id }}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
						<a href="users/del/{{ $row->id }}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></a>
					  </td>
					</tr>
					@endforeach
