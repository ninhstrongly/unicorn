    ...
    <div class="col-lg-12">
        ...
        <div class="form">
            ...
            <div class="form-group ">
                ...
                <div class="col-lg-10">
                <input class=" form-control" id="firstname" name="email" type="text" />
                </div>
            </div>
            <div class="form-group ">
                <label for="lastname" class="control-label col-lg-2">Password</label>
                <div class="col-lg-10">
                <input class=" form-control" id="lastname" name="pass" type="password" />
                </div>
            </div>
            <div class="form-group ">
            ...
            <div class="form-group ">
                ...
                <div class="col-lg-10">
                <input class="form-control " id="password" name="phone" type="text" />
                </div>
            </div>
            <div class="form-group ">
                ...
                <label class="control-label col-lg-2">{{ $row->display_name }}</label>
                <input type="checkbox" value="{{ $row->id }}" style="width: 20px" class="checkbox form-control" id="newsletter" name="roles[]"/>
                @endforeach
                </div>
            </div>
            <div class="form-group">
