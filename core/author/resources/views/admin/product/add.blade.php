                    ...
                    <div class="form">
                        <form class="cmxform form-horizontal style-form" id="signupForm" method="post" action=""
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <input id="inputSlug" class=" form-control" id="firstname" name="slug"
                                        type="text" />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label for="lastname" class="control-label col-lg-2">Giá sản phẩm (Giá chung)</label>
                                <div class="col-lg-10">
                                    <input class=" form-control" id="lastname" name="price" type="number" />
                                </div>
                            </div>
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <div class="panel-body tabs">
                                        ...
                                        <ul class="nav nav-tabs">
                                            ...
                                            @endif
                                            @endforeach()
                                            <li><a href="/admin/product/list-attr">Thêm thuộc tính</a></li>
