...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row mt">
            <div class="col-lg-6">
                <h4 style="color:brown">Thêm Danh Mục</h4>
                <div class="form-panel">
                    <form role="form" class="form-horizontal style-form" name="parent" method="post" id="form-btn">
                        ...
                        <div class="form-group has-error">
                            ...
                            <div class="col-lg-9 ">
                                <input type="text" placeholder="" name="name" id="l-name" class="form-control" value="{{ $cate->name }}">
                            </div>
                        </div>

                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-9">
                                <button type="submit" name="sbm" id="btn-sbm" class="btn btn-theme ">Lưu</button>
                            </div>
                        </div>
                    </form>
                </div>
